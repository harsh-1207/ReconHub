...
export default function ComparisonResultsTable({ rows }) {
  const columns = [
    ...
    { key: 'comparison_status', label: 'Result', render: (value) => <StatusBadge value={value} /> },
  ];
  return <DataTable columns={columns} rows={rows || []} emptyTitle="No comparison results found" />;
}
