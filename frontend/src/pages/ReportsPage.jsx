...
export default function ReportsPage() {
  ...
  return (
    <>
      <PageHeader title="Reports" description="Download stored reconciliation results as Excel or CSV without rerunning the engine." />
      {error && <Alert type="error">{error}</Alert>}
      <Card title="Available reconciliation reports">
        {loading ? <LoadingState label="Loading reports…" /> : <ReconciliationTable rows={rows} showReportActions onDownload={download} downloading={downloading} />}
      </Card>
    </>
  );
}
