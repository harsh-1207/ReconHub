...
const itemFields = new Set(['itemCode', 'description', 'quantity', 'unitPrice', 'itemTax', 'tax', 'amount']);

function isItemRow(row) {
  return Object.keys(row || {}).some((field) => itemFields.has(findCanonical(field, aliases)));
}
